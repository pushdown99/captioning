...
cfg.TEST_SIZE   = 0.1
cfg.CAPTION     = 10
cfg.OBJ_JSON    = join(cfg.ROOT_DIR, cfg.DATA_DIR, 'objects.json')
cfg.IMG_JSON    = join(cfg.ROOT_DIR, cfg.DATA_DIR, 'img.json')
cfg.N41_JSON    = join(cfg.ROOT_DIR, cfg.DATA_DIR, 'n41.json')
cfg.N42_JSON    = join(cfg.ROOT_DIR, cfg.DATA_DIR, 'n42.json')
cfg.N43_JSON    = join(cfg.ROOT_DIR, cfg.DATA_DIR, 'n43.json')
cfg.N44_JSON    = join(cfg.ROOT_DIR, cfg.DATA_DIR, 'n44.json')
cfg.IMG_PKL     = join(cfg.ROOT_DIR, cfg.DATA_DIR, 'img.pkl')
cfg.N41_PKL     = join(cfg.ROOT_DIR, cfg.DATA_DIR, 'n41.pkl')
